...
<body>
    <div class="wrapper ">
        ...
        if (isset($_SESSION['success'])) {
            echo '
            <div class="w-50 mx-auto  mt-3 alert alert-success alert-dismissible show text-center" role="alert">
                            ...
                            <tbody>
                                ...
                                foreach ($detail as $row) {
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-warning " href="blood_request_form.php?id=' . $row[0] . '">
                                            Request Sample
                                        </a>
